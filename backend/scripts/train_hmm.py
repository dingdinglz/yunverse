...
从 vendor/gestures/*.json 读取录制数据，对每个手势训练一个 Left-Right GaussianHMM，
输出 pickle 模型到 vendor/models/。

用法:
    uv run python scripts/train_hmm.py [--data vendor/gestures] [--output vendor/models] [--n-states 6]
"""
...
def main():
    ...
    parser.add_argument("--data", default="vendor/gestures", help="手势数据目录")
    parser.add_argument("--output", default="vendor/models", help="模型输出目录")
